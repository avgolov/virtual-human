...
#include "IntervalLoad.h"
#include "IntervalLoadSysBuilder.h"


namespace Experiments
{
	void IntervalLoad::Run()
	{
		...
		IntervalLoadSysBuilder builder(&config);
		...
		//Solution
		int qty = 0;
		/*auto computeTime = (training.get<double>("Repeats"))*
			(training.get<double>("ExDuration")+ training.get<double>("RestDuration")) +
			config.get<double>("NumericalMethod.SteadyStateTime");*/
		auto computeTime = 60*35+50;
